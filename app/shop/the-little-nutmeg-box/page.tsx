...
<div className="mt-6 space-y-3 text-[#6B584D]">
  ...
  <p>✓ Perfect for journaling & studying</p>
</div>

              <p className="mt-8 text-lg leading-8 text-[#6B584D]">
                A little box of cozy essentials, thoughtfully curated to
                brighten your desk and bring joy to everyday moments.
              </p>
...
Join the Waitlist
  ...
  {[
    ...
    { icon: "🎀", title: "2 Assorted Washi Tapes" },
    { icon: "✨", title: "2 Sticker Sheets" },
    { icon: "🔖", title: "Bookmark" },
    { icon: "🎁", title: "Beautiful Packaging" },
  ].map((item) => (
    <div
      key={item.title}
      ...
      <section className="px-6 pb-10">
        <div className="mx-auto max-w-6xl rounded-[32px] border border-[#EFE7DE] bg-white p-10 shadow-sm">
          ...
          <p className="mt-6 text-lg leading-8 text-[#6B584D]">
            Students, journal lovers, stationery collectors, thoughtful gifts,
            or anyone looking to add a little cozy to their everyday routine.
          </p>
