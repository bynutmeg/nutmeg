...
<div className="mt-6 space-y-3 text-[#6B584D]">
  <p>✓ Our most complete collection</p>
  <p>✓ Premium gift-ready packaging</p>
  <p>✓ Made for everyday creativity</p>
</div>
...
{[
  ...
  { icon: "📒", title: "Memo Pad" },
  { icon: "🖊️", title: "Premium Gel Pen" },
  { icon: "🎀", title: "4 Assorted Washi Tapes" },
  { icon: "✨", title: "Multiple Sticker Sheets" },
      ...
      <section className="px-6 pb-10">
        <div className="mx-auto max-w-6xl rounded-[32px] border border-[#EFE7DE] bg-white p-10 shadow-sm">
          ...
          <p className="mt-6 text-lg leading-8 text-[#6B584D]">
           Designed for journal lovers, students, creators, and anyone who enjoys surrounding themselves with beautiful stationery and thoughtful little details.
          </p>
